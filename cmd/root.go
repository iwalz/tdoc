...
func init() {
	...
	defaultConfig, _ := homedir.Expand("~/.tdoc.yaml")
	// Here you will define your flags and configuration settings.
	// Cobra supports Persistent Flags, which, if defined here,
	// will be global for your application.
	RootCmd.PersistentFlags().StringVarP(&cfgFile, "config", "c", defaultConfig, "config file")
	RootCmd.PersistentFlags().StringVarP(&extension, "extension", "e", "tdoc", "file extension to use")
	RootCmd.PersistentFlags().StringVarP(&SvgDir, "svgdir", "s", defaultDir, "Source directory for components. foo.svg will make component foo available")
